...
set_xorg_params() {
  ...
  # TODO: why resolutions lower than 640x400 are not supported by Xorg?
  ...
  elif [[ "$width" -eq 864 ]] && [[ "$height" -eq 486 ]]; then
    modeline_values="32.90 864 888 976 1088 486 487 490 504"
